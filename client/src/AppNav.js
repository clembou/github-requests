  ...
  <Navbar inverse fixedTop>
    ...
    <Navbar.Collapse>
      <Nav>
        ...
        {props.isAuthenticated && props.isAdmin && <MenuLink activeOnlyWhenExact={true} to="/backlog" label="Backlog" />}
      </Nav>
      <Nav pullRight>
        {props.isAuthenticated &&
          ...
          <NavDropdown eventKey="5" title={`Signed in as ${props.userProfile.name}`} id="nav-dropdown-profile" pullRight>
            ...
            {props.isAuthenticated && props.isAdmin == null && <MenuItemLink to="/admin-consent" label="Enable admin features" />}
            {process.env.NODE_ENV !== 'production' && <MenuItem onClick={() => props.onToggleAdmin()}>Toggle Admin</MenuItem>}
